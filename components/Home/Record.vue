    ...
    <v-container>
      <v-row justify="center" align="center">
        ...
        <v-col cols="12" sm="6" lg="3" class="text-center">
          ...
          <p>
            <i>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur culpa, eum fugit harum id itaque
              laudantium officiis perferendis praesentium sapiente.
            </i>
          </p>
        </v-col>
        <v-col cols="12" sm="10" md="8" lg="4">
          <v-card tile>
            ...
            <v-card-text class="s-bg--primary pt-5">
              <p class="mt-0">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusamus assumenda cumque eius ipsum iure
                laudantium optio, vel vitae? Perspiciatis.
              </p>
            </v-card-text>
          </v-card>
        </v-col>
